...
alter table productStorage add unique index idx_str(storageLocation);
alter table supplier add unique index idx_sup(socialName);
alter table product add unique index idx_pname(pName);
alter table clients add unique index idx_client(minit);
